...
class TextChunker:
    def __init__(self, chunk_size, chunk_overlap, length_function, separators, minimum_chunk_size=20):
...
def run_chunker(output_directory_path: str = None, chunk_size: int = 512, chunk_overlap: int = 0, minimum_chunk_size: int = 20):
