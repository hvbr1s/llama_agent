...
from routes.semantic_routes import chitchat, operator, niceties, languages, phone, ROUTER_DICTIONARY
...
routes = [chitchat, operator, niceties, languages, phone]
for route in routes:
    route.score_threshold = 0.45 
rl = RouteLayer(
...
#async def react_description(query: Query): # Gradio testing
